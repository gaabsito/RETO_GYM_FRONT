        ...
        <v-card v-if="showCommentForm" class="mb-6 pa-4 comment-form">
          ...
          <v-card-text class="px-0">
            <v-textarea
              v-if="isEditing"
              v-model="editContent"
              label="Comparte tu opinión sobre este entrenamiento"
              variant="outlined"
              rows="3"
              hide-details
              class="mb-4"
            ...
            <div class="d-flex flex-column flex-sm-row align-center">
              ...
              <div class="d-flex">
                ...
                <v-btn
                  color="primary"
                  @click="isEditing ? updateComment() : addComment()"
        ...
        >
          <v-card-text>
            ...
            <div v-if="isCommentAuthor(comment)" class="d-flex justify-end mt-2">
              <v-btn size="small" variant="text" icon="mdi-pencil" @click="startEditComment(comment)" class="me-1"></v-btn>
              <v-btn size="small" variant="text" icon="mdi-delete" @click="deleteComment(comment.comentarioID)"></v-btn>
            </div>
          </v-card-text>
        </v-card>
      </div>
